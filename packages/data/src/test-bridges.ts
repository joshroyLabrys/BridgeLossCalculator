...
//
// Major inner-city crossing of the Brisbane River connecting the CBD
// (north bank) to South Brisbane. The current bridge (opened 1969) is a
// prestressed concrete structure with 6 spans and 5 cylindrical piers.
// Converted to dedicated busway in 2014.
//
// Cross-section approximated from Brisbane River Catchment Flood Study
// (2017) bathymetry and LiDAR at the bridge alignment. Deep tidal
// channel (thalweg approx −7 m AHD) with steep urban banks.
//
// Flood levels and discharges from Brisbane River Catchment Flood Study
// (BMT, 2017) and observed data from the January 2011 flood event.
// The 2011 peak at the City Gauge was 4.46 m AHD (~11,900 m³/s).
//
// All values in metres and m³/s (native metric).
//
// References:
//   Brisbane River Catchment Flood Study, BMT WBM (2017)
//   BOM Flood Warning System — Brisbane River at City Gauge
...
const victoriaBridge: TestBridge = {
  ...
  description:
    'Inner-city Brisbane River crossing. 5 cylindrical piers, 15° skew, deep tidal channel. Includes 2011 historic flood event. Full simulation with debris, sensitivity, and all methods.',
  imageUrl: '',
  crossSection: [
    // Left (north) bank — CBD side, steep engineered riverwall
    { station: 0, elevation: 8.5, manningsN: 0.025, bankStation: null },
    { station: 15, elevation: 6.0, manningsN: 0.025, bankStation: null },
    { station: 30, elevation: 4.5, manningsN: 0.028, bankStation: null },
    { station: 50, elevation: 3.0, manningsN: 0.03, bankStation: null },
    // Left bank
    { station: 65, elevation: 1.5, manningsN: 0.03, bankStation: 'left' },
    // Main channel — deep tidal Brisbane River
    { station: 85, elevation: -1.5, manningsN: 0.028, bankStation: null },
    { station: 110, elevation: -4.0, manningsN: 0.025, bankStation: null },
    { station: 135, elevation: -6.5, manningsN: 0.022, bankStation: null },
    { station: 155, elevation: -7.2, manningsN: 0.022, bankStation: null },
    { station: 175, elevation: -6.8, manningsN: 0.022, bankStation: null },
    { station: 200, elevation: -5.0, manningsN: 0.025, bankStation: null },
    { station: 225, elevation: -2.5, manningsN: 0.025, bankStation: null },
    { station: 245, elevation: 0.0, manningsN: 0.028, bankStation: null },
    // Right bank
    { station: 260, elevation: 1.8, manningsN: 0.03, bankStation: 'right' },
    // Right (south) bank — South Brisbane, moderate slope to parkland
    { station: 275, elevation: 3.5, manningsN: 0.035, bankStation: null },
    { station: 295, elevation: 5.0, manningsN: 0.04, bankStation: null },
    { station: 315, elevation: 6.5, manningsN: 0.04, bankStation: null },
    { station: 340, elevation: 8.5, manningsN: 0.045, bankStation: null },
  ],
  bridgeGeometry: {
    lowChordLeft: 8.2,
    lowChordRight: 8.0,
    highChord: 10.5,
    leftAbutmentStation: 55,
    rightAbutmentStation: 270,
    contractionLength: 180,
    expansionLength: 250,
    orificeCd: 0.8,
    weirCw: 1.5,
    deckWidth: 23.0,
    skewAngle: 15,
    piers: [
      { station: 98, width: 2.0, shape: 'cylindrical' },
      { station: 138, width: 2.0, shape: 'cylindrical' },
      { station: 178, width: 2.0, shape: 'cylindrical' },
      { station: 218, width: 2.0, shape: 'cylindrical' },
      { station: 250, width: 2.0, shape: 'cylindrical' },
    ],
    lowChordProfile: [
      { station: 55, elevation: 8.2 },
      { station: 98, elevation: 8.1 },
      { station: 138, elevation: 8.0 },
      { station: 178, elevation: 7.9 },
      { station: 218, elevation: 8.0 },
      { station: 250, elevation: 8.0 },
      { station: 270, elevation: 8.0 },
    ],
  },
  flowProfiles: [
    {
